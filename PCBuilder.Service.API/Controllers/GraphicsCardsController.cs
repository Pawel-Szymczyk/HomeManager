...
namespace PCBuilder.Service.API.Controllers
{
    ...
    public class GraphicsCardsController : ControllerBase
    {
        ...
        /// <summary>
        /// Get single graphics gard entity.
        /// </summary>
        /// <remarks>
        /// Sample request:
        /// 
        ...
        /// </remarks>
        /// <param name="Id">(Guid) Graphics gard identificator.</param>
        /// <returns>Return graphics gard object.</returns>
        [HttpGet("{id}")]
        ...
        /// <summary>
        /// Creates a graphics gard entity.
        /// </summary>
        /// <remarks>
        /// Sample request:
        ///
        ...
        ///
        /// </remarks>
        /// <param name="model">graphics gard model (object).</param>
